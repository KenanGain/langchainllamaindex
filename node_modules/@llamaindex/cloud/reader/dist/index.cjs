 ...
 */ class LlamaParseReader extends schema.FileReader {
    ...
    async createJob(data) {
        ...
        const response = await index_cjs.ParsingService.uploadFileApiV1ParsingUploadPost({
            client: this.#client,
            throwOnError: true,
    ...
    async getJobResult(jobId, resultType) {
        ...
        while(true){
            ...
            const result = await index_cjs.ParsingService.getJobApiV1ParsingJobJobIdGet({
                client: this.#client,
                throwOnError: true,
                path: {
                    job_id: jobId
            ...
            if (status === "SUCCESS") {
                ...
                switch(resultType){
                    case "json":
                        {
                            result = await index_cjs.ParsingService.getJobJsonResultApiV1ParsingJobJobIdResultJsonGet({
                                client: this.#client,
                                throwOnError: true,
                                path: {
                                    job_id: jobId
                    ...
                    case "markdown":
                        {
                            result = await index_cjs.ParsingService.getJobResultApiV1ParsingJobJobIdResultMarkdownGet({
                                client: this.#client,
                                throwOnError: true,
                                path: {
                                    job_id: jobId
                    ...
                    case "text":
                        {
                            result = await index_cjs.ParsingService.getJobTextResultApiV1ParsingJobJobIdResultTextGet({
                                client: this.#client,
                                throwOnError: true,
                                path: {
                                    job_id: jobId
   ...
   */ async getImages(jsonResult, downloadPath) {
    ...
    async fetchAndSaveImage(imageName, imagePath, jobId) {
        const response = await index_cjs.ParsingService.getJobImageResultApiV1ParsingJobJobIdResultImageNameGet({
            client: this.#client,
            path: {
                job_id: jobId,
                name: imageName
    ...
    static async getMimeType(data) {
        const typeinfos = magicBytes_js.filetypeinfo(data);
