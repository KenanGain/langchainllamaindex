...
declare const AzureOpenAIEmbeddingSchema: {
    readonly properties: {
        ...
        readonly azure_ad_token_provider: {
            readonly anyOf: readonly [{
                readonly type: "string";
            }, {
                readonly type: "null";
            }];
            readonly title: "Azure Ad Token Provider";
            readonly description: "Callback function to provide Azure AD token.";
        };
...
declare const CloudChromaVectorStoreSchema: {
    readonly properties: {
        readonly supports_nested_metadata_filters: {
            readonly type: "boolean";
...
declare const CloudWeaviateVectorStoreSchema: {
    readonly properties: {
        readonly supports_nested_metadata_filters: {
            readonly type: "boolean";
            readonly enum: readonly [false];
...
declare const ConfigurableDataSinkNamesSchema: {
    readonly type: "string";
    readonly enum: readonly ["CHROMA", "PINECONE", "POSTGRES", "QDRANT", "WEAVIATE", "AZUREAI_SEARCH", "MONGODB_ATLAS", "MILVUS"];
...
declare const ConfigurableTransformationNamesSchema: {
    readonly type: "string";
    readonly enum: readonly ["CHARACTER_SPLITTER", "PAGE_SPLITTER_NODE_PARSER", "CODE_NODE_PARSER", "SENTENCE_AWARE_NODE_PARSER", "TOKEN_AWARE_NODE_PARSER", "MARKDOWN_NODE_PARSER", "MARKDOWN_ELEMENT_NODE_PARSER", "OPENAI_EMBEDDING", "AZURE_EMBEDDING", "COHERE_EMBEDDING", "BEDROCK_EMBEDDING", "HUGGINGFACE_API_EMBEDDING", "GEMINI_EMBEDDING", "VERTEXAI_EMBEDDING"];
    ...
    readonly properties: {
        ...
        readonly component: {
            readonly anyOf: readonly [{
                ...
                readonly $ref: "#/components/schemas/ExtendVertexTextEmbedding";
            }];
...
declare const ExtendVertexTextEmbeddingSchema: {
    readonly properties: {
        readonly model_name: {
            readonly type: "string";
            readonly title: "Model Name";
        ...
        readonly client_email: {
            ...
            readonly description: "The client email to use when making Vertex API calls.";
        };
        readonly token_uri: {
            readonly anyOf: readonly [{
                readonly type: "string";
            ...
            readonly description: "The token uri to use when making Vertex API calls.";
        };
        readonly private_key_id: {
            ...
            readonly description: "The private key id to use when making Vertex API calls.";
        };
        readonly private_key: {
            ...
            readonly description: "The private key to use when making Vertex API calls.";
        };
        readonly project: {
            readonly type: "string";
        ...
        readonly class_name: {
            readonly type: "string";
            readonly title: "Class Name";
            readonly default: "ExtendVertexTextEmbedding";
        };
    };
    readonly type: "object";
    readonly required: readonly ["embed_mode", "client_email", "token_uri", "private_key_id", "private_key", "project", "location"];
    readonly title: "ExtendVertexTextEmbedding";
};
...
type AzureOpenAIEmbedding = {
    ...
    /**
     * Callback function to provide Azure AD token.
     */
    azure_ad_token_provider?: string | null;
    /**
...
type ConfigurableDataSinkNames = "CHROMA" | "PINECONE" | "POSTGRES" | "QDRANT" | "WEAVIATE" | "AZUREAI_SEARCH" | "MONGODB_ATLAS" | "MILVUS";
...
type ConfigurableTransformationNames = "CHARACTER_SPLITTER" | "PAGE_SPLITTER_NODE_PARSER" | "CODE_NODE_PARSER" | "SENTENCE_AWARE_NODE_PARSER" | "TOKEN_AWARE_NODE_PARSER" | "MARKDOWN_NODE_PARSER" | "MARKDOWN_ELEMENT_NODE_PARSER" | "OPENAI_EMBEDDING" | "AZURE_EMBEDDING" | "COHERE_EMBEDDING" | "BEDROCK_EMBEDDING" | "HUGGINGFACE_API_EMBEDDING" | "GEMINI_EMBEDDING" | "VERTEXAI_EMBEDDING";
...
type ConfiguredTransformationItem = {
    ...
    component: {
        [key: string]: unknown;
    } | CharacterSplitter | PageSplitterNodeParser | CodeSplitter | SentenceSplitter | TokenTextSplitter | MarkdownNodeParser | MarkdownElementNodeParser | OpenAIEmbedding | AzureOpenAIEmbedding | CohereEmbedding | BedrockEmbedding | HuggingFaceInferenceAPIEmbedding | GeminiEmbedding | ExtendVertexTextEmbedding;
};
...
type DataSink = {
    ...
    component: {
        [key: string]: unknown;
    } | CloudChromaVectorStore | CloudPineconeVectorStore | CloudPostgresVectorStore | CloudQdrantVectorStore | CloudWeaviateVectorStore | CloudAzureAISearchVectorStore | CloudMongoDBAtlasVectorSearch | CloudMilvusVectorStore;
    project_id: string;
};
/**
...
type DataSinkUpdate = {
    ...
    component?: {
        [key: string]: unknown;
    } | CloudChromaVectorStore | CloudPineconeVectorStore | CloudPostgresVectorStore | CloudQdrantVectorStore | CloudWeaviateVectorStore | CloudAzureAISearchVectorStore | CloudMongoDBAtlasVectorSearch | CloudMilvusVectorStore | null;
};
/**
...
type ExtendVertexTextEmbedding = {
    /**
     * The name of the embedding model.
     */
    model_name?: string;
    ...
    /**
     * The client email to use when making Vertex API calls.
     */
    client_email: string | null;
    /**
     * The token uri to use when making Vertex API calls.
     */
    token_uri: string | null;
    /**
     * The private key id to use when making Vertex API calls.
     */
    private_key_id: string | null;
    /**
     * The private key to use when making Vertex API calls.
     */
...
type VertexAIEmbeddingConfig = {
     ...
     */
    component?: ExtendVertexTextEmbedding;
};
/**
 * Type of the embedding model.
 */
...
declare const client: _hey_api_client_fetch.Client<Request, Response, _hey_api_client_fetch.RequestOptions>;
