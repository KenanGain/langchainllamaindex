...
const CloudChromaVectorStoreSchema = {
    properties: {
        supports_nested_metadata_filters: {
            type: "boolean",
            enum: [
...
const CloudWeaviateVectorStoreSchema = {
    properties: {
        supports_nested_metadata_filters: {
            type: "boolean",
            enum: [
    ...
    properties: {
        ...
        component: {
            anyOf: [
                ...
                {
                    $ref: "#/components/schemas/ExtendVertexTextEmbedding"
                }
            ],
            title: "Component",
...
const ExtendVertexTextEmbeddingSchema = {
    properties: {
        model_name: {
            type: "string",
            title: "Model Name",
        ...
        token_uri: {
            ...
            title: "Token Uri",
            description: "The token uri to use when making Vertex API calls."
        },
        private_key_id: {
            anyOf: [
                {
        ...
        class_name: {
            type: "string",
            title: "Class Name",
            default: "ExtendVertexTextEmbedding"
        }
    },
    type: "object",
    required: [
    ...
    title: "ExtendVertexTextEmbedding"
};
...
const VertexEmbeddingModeSchema = {
    ...
    description: `VertexAI embedding mode.
...
const e = /\{[^{}]+\}/g, t = ({ allowReserved: e, name: t, value: r })=>{
    if (null == r) return "";
    if ("object" == typeof r) throw new Error("Deeply-nested arrays/objects aren’t supported. Provide your own `querySerializer()` to handle these.");
...
const c = (e, t, r)=>{
    "string" == typeof r || r instanceof Blob ? e.append(t, r) : e.append(t, JSON.stringify(r));
}, u = {
    bodySerializer: (e)=>{
        const t = new FormData;
        return Object.entries(e).forEach(([e, r])=>{
            null != r && (Array.isArray(r) ? r.forEach((r)=>c(t, e, r)) : c(t, e, r));
        }), t;
    }
}, d = {
...
export { APIKeyCreateSchema, APIKeySchema, APIKeyUpdateSchema, AdvancedModeTransformConfigSchema, ApiKeysService, AutoTransformConfigSchema, AzureOpenAIEmbeddingConfigSchema, AzureOpenAIEmbeddingSchema, BaseConnectionValidationSchema, BasePromptTemplateSchema, BaseSchema, BedrockEmbeddingConfigSchema, BedrockEmbeddingSchema, BillingService, Body_import_pipeline_metadata_api_v1_pipelines__pipeline_id__metadata_putSchema, Body_upload_file_api_parsing_upload_postSchema, Body_upload_file_api_v1_files_postSchema, Body_upload_file_api_v1_parsing_upload_postSchema, BoxAuthMechanism, BoxAuthMechanismSchema, CharacterChunkingConfigSchema, CharacterSplitterSchema, ChatDataSchema, ChatInputParamsSchema, ChatMessageSchema, CheckoutSessionCreatePayloadSchema, CloudAzStorageBlobDataSourceSchema, CloudAzureAISearchVectorStoreSchema, CloudBoxDataSourceSchema, CloudChromaVectorStoreSchema, CloudConfluenceDataSourceSchema, CloudDocumentCreateSchema, CloudDocumentSchema, CloudGoogleDriveDataSourceSchema, CloudJiraDataSourceSchema, CloudMilvusVectorStoreSchema, CloudMongoDBAtlasVectorSearchSchema, CloudNotionPageDataSourceSchema, CloudOneDriveDataSourceSchema, CloudPineconeVectorStoreSchema, CloudPostgresVectorStoreSchema, CloudQdrantVectorStoreSchema, CloudS3DataSourceSchema, CloudSharepointDataSourceSchema, CloudSlackDataSourceSchema, CloudWeaviateVectorStoreSchema, CodeSplitterSchema, CohereEmbeddingConfigSchema, CohereEmbeddingSchema, ComponentDefinitionsService, ConfigurableDataSinkNames, ConfigurableDataSinkNamesSchema, ConfigurableDataSourceNames, ConfigurableDataSourceNamesSchema, ConfigurableTransformationDefinitionSchema, ConfigurableTransformationNames, ConfigurableTransformationNamesSchema, ConfiguredTransformationItemSchema, CustomerPortalSessionCreatePayloadSchema, DataSinkCreateSchema, DataSinkDefinitionSchema, DataSinkSchema, DataSinkUpdateSchema, DataSinksService, DataSourceCreateSchema, DataSourceDefinitionSchema, DataSourceSchema, DataSourceUpdateSchema, DataSourcesService, DefaultOrganizationUpdateSchema, DefaultService, DeprecatedService, ElementSegmentationConfigSchema, EvalDatasetCreateSchema, EvalDatasetJobParamsSchema, EvalDatasetJobRecordSchema, EvalDatasetSchema, EvalDatasetUpdateSchema, EvalExecutionCreateSchema, EvalExecutionParamsOverrideSchema, EvalExecutionParamsSchema, EvalMetric, EvalMetricSchema, EvalQuestionCreateSchema, EvalQuestionResultSchema, EvalQuestionSchema, EvalsService, ExtendVertexTextEmbeddingSchema, ExtractionJobCreateBatchSchema, ExtractionJobCreateSchema, ExtractionJobSchema, ExtractionResultSchema, ExtractionSchemaCreateSchema, ExtractionSchemaInferSchema, ExtractionSchemaSchema, ExtractionSchemaUpdateSchema, ExtractionService, FileCreateSchema, FileSchema, FilesService, FilterCondition, FilterConditionSchema, FilterOperator, FilterOperatorSchema, GeminiEmbeddingConfigSchema, GeminiEmbeddingSchema, HTTPValidationErrorSchema, HuggingFaceInferenceAPIEmbeddingConfigSchema, HuggingFaceInferenceAPIEmbeddingSchema, IngestionErrorResponseSchema, InputMessageSchema, JobNameMapping, JobNameMappingSchema, LLMModelDataSchema, LLMParametersSchema, LLMSchema, LlamaParseParametersSchema, LlamaParseSupportedFileExtensions, LlamaParseSupportedFileExtensionsSchema, LocalEvalResultsSchema, LocalEvalSchema, LocalEvalSetCreateSchema, LocalEvalSetsSchema, ManagedIngestionStatus, ManagedIngestionStatusResponseSchema, ManagedIngestionStatusSchema, MarkdownElementNodeParserSchema, MarkdownNodeParserSchema, MessageAnnotationSchema, MessageRole, MessageRoleSchema, MetadataFilterSchema, MetadataFiltersSchema, MetricResultSchema, NodeParserSchema, NodeRelationship, NodeRelationshipSchema, NoneChunkingConfigSchema, NoneSegmentationConfigSchema, ObjectType, ObjectTypeSchema, OpenAIEmbeddingConfigSchema, OpenAIEmbeddingSchema, OrganizationCreateSchema, OrganizationSchema, OrganizationUpdateSchema, OrganizationsService, PageScreenshotMetadataSchema, PageScreenshotNodeWithScoreSchema, PageSegmentationConfigSchema, PageSplitterNodeParserSchema, ParserLanguages, ParserLanguagesSchema, ParsingHistoryItemSchema, ParsingJobJsonResultSchema, ParsingJobMarkdownResultSchema, ParsingJobSchema, ParsingJobTextResultSchema, ParsingService, ParsingUsageSchema, PartitionNames, PartitionNamesSchema, PipelineConfigurationHashesSchema, PipelineCreateSchema, PipelineDataSourceCreateSchema, PipelineDataSourceSchema, PipelineDataSourceUpdateSchema, PipelineDeploymentSchema, PipelineFileCreateSchema, PipelineFileSchema, PipelineFileUpdateSchema, PipelineSchema, PipelineType, PipelineTypeSchema, PipelineUpdateSchema, PipelinesService, PlaygroundSessionSchema, Pooling, PoolingSchema, PresetRetrievalParamsSchema, PresignedUrlSchema, ProjectCreateSchema, ProjectSchema, ProjectUpdateSchema, ProjectsService, PromptMixinPromptsSchema, PromptSpecSchema, PydanticProgramMode, PydanticProgramModeSchema, RelatedNodeInfoSchema, RetrievalMode, RetrievalModeSchema, RetrievalParamsSchema, RetrieveResultsSchema, SemanticChunkingConfigSchema, SentenceChunkingConfigSchema, SentenceSplitterSchema, StatusEnum, StatusEnumSchema, SupportedLLMModelNames, SupportedLLMModelNamesSchema, SupportedLLMModelSchema, TextNodeSchema, TextNodeWithScoreSchema, TokenChunkingConfigSchema, TokenTextSplitterSchema, TransformationCategoryNames, TransformationCategoryNamesSchema, UserOrganizationCreateSchema, UserOrganizationDeleteSchema, UserOrganizationSchema, ValidationErrorSchema, VertexAIEmbeddingConfigSchema, VertexEmbeddingMode, VertexEmbeddingModeSchema, client, job_name, mode, mode2, mode3, mode4, mode5, mode6, mode7, mode8, mode9, type, type2, type3, type4, type5, type6, type7 };
