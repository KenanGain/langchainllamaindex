import { getTransformers, setTransformers } from "./shared.js";
export { setTransformers } from "./shared.js";
export async function loadTransformers(onLoad) {
     ...
     */ console.warn('"@xenova/transformers" is not officially supported in this environment, some features may not work as expected.');
        setTransformers(// @ts-expect-error
