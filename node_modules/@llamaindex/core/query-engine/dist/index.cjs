...
var _initProto;
class BaseQueryEngine extends index_cjs.PromptMixin {
    static{
        ({ e: [_initProto] } = _apply_decs_2203_r(this, [
            [
                index_cjs$1.wrapEventCaller,
                2,
                "query"
            ]
        ], []));
    ...
    async query(params) {
        ...
        const callbackManager = index_cjs$2.Settings.callbackManager;
...
exports.BaseQueryEngine = BaseQueryEngine;
