...
type KeywordExtractPrompt = PromptTemplate<["context"]>;
...
export { BasePromptTemplate, type BasePromptTemplateOptions, type ChoiceSelectPrompt, type CondenseQuestionPrompt, type ContextSystemPrompt, type KeywordExtractPrompt, type ModuleRecord, PromptMixin, PromptTemplate, type PromptTemplateOptions, type PromptsRecord, type QueryKeywordExtractPrompt, type RefinePrompt, type StringTemplate, type SubQuestionPrompt, type SummaryPrompt, type TextQAPrompt, type TreeSummarizePrompt, anthropicSummaryPrompt, anthropicTextQaPrompt, defaultChoiceSelectPrompt, defaultCondenseQuestionPrompt, defaultContextSystemPrompt, defaultKeywordExtractPrompt, defaultQueryKeywordExtractPrompt, defaultRefinePrompt, defaultSubQuestionPrompt, defaultSummaryPrompt, defaultTextQAPrompt, defaultTreeSummarizePrompt };
