 ...
 */ class Refine extends BaseSynthesizer {
    ...
    async getResponse(query, nodes, stream) {
        ...
        if (typeof response === "string") {
            ...
            return streamConverter(response, (text)=>EngineResponse.fromResponse(text, true));
        }
    }
    ...
    async getResponse(query, nodes, stream) {
        ...
        if (packedTextChunks.length === 1) {
            ...
            if (stream) {
                ...
                return streamConverter(response, (chunk)=>EngineResponse.fromResponse(chunk.text, true));
            }
            return EngineResponse.fromResponse((await this.llm.complete(params)).text, false);
        } else {
