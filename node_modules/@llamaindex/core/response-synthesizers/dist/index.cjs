 ...
 */ class Refine extends BaseSynthesizer {
    ...
    async getResponse(query, nodes, stream) {
        ...
        if (typeof response === "string") {
            return index_cjs$3.EngineResponse.fromResponse(response, false);
        } else {
            return index_cjs$4.streamConverter(response, (text)=>index_cjs$3.EngineResponse.fromResponse(text, true));
        }
    }
    ...
    async getResponse(query, nodes, stream) {
        ...
        if (packedTextChunks.length === 1) {
            ...
            if (stream) {
                ...
                return index_cjs$4.streamConverter(response, (chunk)=>index_cjs$3.EngineResponse.fromResponse(chunk.text, true));
            }
            return index_cjs$3.EngineResponse.fromResponse((await this.llm.complete(params)).text, false);
        } else {
...
class MultiModal extends BaseSynthesizer {
    ...
    async getResponse(query, nodes, stream) {
        ...
        return index_cjs$3.EngineResponse.fromResponse(response.text, false);
    }
}
