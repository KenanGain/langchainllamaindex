...
class OpenAI extends llms.ToolCallLLM {
    ...
    get metadata() {
        ...
        return {
            ...
            contextWindow,
            tokenizer: env.Tokenizers.CL100K_BASE
        };
    }
...
class OpenAIEmbedding extends embeddings.BaseEmbedding {
   ...
   */ this.getTextEmbeddings = async (texts)=>{
        ...
        if (init?.azure || shouldUseAzure()) {
            ...
            this.lazySession = async ()=>import('openai').then(async ({ AzureOpenAI })=>init?.session ?? new AzureOpenAI({
                        maxRetries: this.maxRetries,
                        timeout: this.timeout,
                        ...this.additionalSessionOptions,
                        ...azureConfig
