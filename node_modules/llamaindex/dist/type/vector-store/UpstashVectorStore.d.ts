import { VectorStoreBase, type IEmbedModel, type MetadataFilter, type MetadataFilters, type VectorStoreNoEmbedModel, type VectorStoreQuery, type VectorStoreQueryResult } from "./types.js";
 ...
 */
export declare class UpstashVectorStore extends VectorStoreBase implements VectorStoreNoEmbedModel {
    storesText: boolean;
    private db;
