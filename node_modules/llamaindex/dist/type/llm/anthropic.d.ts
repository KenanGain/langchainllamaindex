...
import type { BaseTool, ChatMessage, ChatResponse, ChatResponseChunk, LLMChatParamsNonStreaming, LLMChatParamsStreaming, ToolCallLLMMessageOptions } from "@llamaindex/core/llms";
...
export declare const ALL_AVAILABLE_V3_5_MODELS: {
    "claude-3-5-sonnet": {
        contextWindow: number;
    };
};
